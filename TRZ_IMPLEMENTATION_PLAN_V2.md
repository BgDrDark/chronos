...
| # | Задача | Файлове | Тестване | Документация |
|---|--------|---------|----------|--------------|
| 1.5.1 | Майчинство 410 дни (чл. 163 КТ) | `models.py`, `mutations.py` | ✅ | ✅ |
| 1.5.2 | Бащинство 15 дни | `models.py`, `mutations.py` | ✅ | ✅ |
| 1.5.3 | Родителски отпуск | `models.py`, `mutations.py` | ✅ | ✅ |
| 1.5.4 | Неплатен отпуск | `LeaveRequest` (update) | ✅ | ✅ |
| 1.5.5 | Болничен 1-ви ден 80% | `enhanced_payroll_calculator.py` | ✅ | ✅ |
| 1.5.6 | Тестване | `test_leaves.py` | ✅ | - |

### 6.5 Критерии за Приключване

- [ ] Всички видове отпуски се поддържат
- [ ] Изчисленията са коректни
- [ ] Интеграцията с Payroll работи
...
| 1.6.3 | Прикачане на банкови извлечения | `mutations.py`, `schemas.py` | ✅ | ✅ |
...
- [ ] Bulk Pay маркира много заплати като платени
- [ ] SEPA XML е валиден
- [ ] Файловете могат да се прикачат
...
| # | Задача | Файлове | Тестване | Документация |
|---|--------|---------|----------|--------------|
| 1.7.1 | Интеграция с НАП (е-портал) | `nap_integration.py` | ✅ | ✅ |
| 1.7.2 | Годишна справка за осигурени лица | `reports.py` | ✅ | ✅ |
| 1.7.3 | Справка по чл. 73, ал. 6 ЗДДФЛ | `reports.py` | ✅ | ✅ |
| 1.7.4 | Тестване | `test_reports.py` | ✅ | - |

### 8.4 Критерии за Приключване

- [ ] Справките са в правилния формат
- [ ] Интеграцията с НАП работи
- [ ] Експортът е коректен
