  ...
  const menuItems = [
    ...
    { 
      ...
      children: [
        ...
        { text: 'Назначаване на тестове', path: '/admin/behavioral-analysis/test-assignments', visible: true },
    ...
    { 
      text: 'Контрол на достъп', 
      icon: <DoorIcon />, 
      visible: isAdmin && isEnabled('kiosk'),
      children: [
        { text: 'Зони за достъп', path: '/admin/access-control/zones', visible: true },
        { text: 'Врати', path: '/admin/access-control/doors', visible: true },
        { text: 'Нива на достъп', path: '/admin/access-control/access-levels', visible: true },
        { text: 'Графици за достъп', path: '/admin/access-control/schedules', visible: true },
