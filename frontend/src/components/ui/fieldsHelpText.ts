...
export const accessControlFieldsHelp = {
  zoneId: 'Уникален идентификатор на зоната за достъп',
  zoneName: 'Наименование на зоната за достъп',
  zoneLevel: 'Ниво на сигурност (1-3), определящо чувствителността на зоната',
  parentZone: 'Родителска зона за йерархична организация',
  inheritPermissions: 'Наследяване на правата за достъп от родителската зона',
  dependsOn: 'Зони, които трябва да бъдат преминати преди достъп до тази зона',
  requiredHoursStart: 'Начален час за разрешен достъп',
  requiredHoursEnd: 'Краен час за разрешен достъп',
  antiPassbackEnabled: 'Предотвратява повторно влизане без излизане (anti-passback)',
  antiPassbackType: 'Мек (предупреждение) или твърд (отказ) anti-passback',
  antiPassbackTimeout: 'Време в минути за анулиране на anti-passback',
  requiredAuthFactors: 'Фактори за автентикация: карта, ПИН, биометрия',
  interlockEnabled: 'Междузоново блокиране — една зона трябва да се затвори преди следващата',
  interlockTimeout: 'Максимално време в секунди за преминаване между зоните със активна interlocks',
  dualAuthEnabled: 'Двама различни потребителя трябва да се автентикират едновременно или последователно за достъп',
  dualAuthTimeout: 'Максимално време в секунди между двете автентикации',
  isSafeZone: 'Безопасна зона за укриване при извънредни ситуации',
  lockdownBehavior: 'Поведение при заключване (заключване/отключване/изолация)',
  emergencyContact: 'Телефон за връзка при извънредни ситуации в зоната',
  doorName: 'Наименование на вратата',
  doorId: 'Уникален идентификатор на вратата',
  deviceId: 'Идентификатор на устройството',
  gatewayId: 'Избери gateway, към който е свързана вратата',
  relayNumber: 'Номер на релето на gateway-то за тази врата',
  terminalId: 'Терминал за четене на карти/биометрия',
  doorZone: 'Зона, към която принадлежи вратата',
  accessLevelName: 'Наименование на нивото за достъп',
  accessLevelDescription: 'Описание на нивото за достъп',
  scheduleName: 'Наименование на графика за достъп',
  scheduleDescription: 'Описание на графика за достъп',
  elevatorGroup: 'Групиране на етажи с общи права за достъп',
  elevatorFloor: 'Етаж, достъпен от етажната група',
  emergencyEventType: 'Тип на извънредната ситуация',
  emergencyScope: 'Обхват на извънредната ситуация',
  emergencyNotes: 'Допълнителни бележки за извънредната ситуация',
};
