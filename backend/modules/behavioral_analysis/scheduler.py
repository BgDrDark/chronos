...
async def cleanup_old_data():
    ...
    from backend.modules.behavioral_analysis.models import (
        BehavioralRetentionSettings, BehavioralProfile, BehavioralRecommendation,
        RecommendationFeedback, BehavioralAnomaly
    )
    ...
    async with AsyncSessionLocal() as db:
        ...
        for settings in settings_list:
            ...
            cutoff_date = datetime.utcnow() - timedelta(days=settings.raw_profile_days)
