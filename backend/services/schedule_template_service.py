...
class ScheduleTemplateService:
    ...
    async def get_templates(self, company_id: int | None = None) -> list[ScheduleTemplate]:
        """Get all templates"""
    ...
    async def get_template(self, template_id: int, company_id: int | None = None) -> ScheduleTemplate | None:
    ...
    async def delete_template(self, template_id: int, company_id: int | None = None) -> bool:
        """Delete a template"""
